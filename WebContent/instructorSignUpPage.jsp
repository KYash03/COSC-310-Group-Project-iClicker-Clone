...
<body>
    ...
    <div id="container">
        ...
        <p id="page-title">Instructor Sign-Up Page</p>
        <div id="container-2">
            <form id="user-form" method="post" action="instructorSignUpPage.jsp" class="login-form">
                ...
                <label for="instructor-department"></label>
                <input type="text" id="dept" name="Department" placeholder="Department" required/>
    ...
    <% } else {
     ...
     <a id="sign-in-button" href="loginPage.html">Have an account? Sign In!</a>
    </div>
</body>
